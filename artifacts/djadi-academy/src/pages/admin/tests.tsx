...
export default function AdminTests() {
  ...
  function submit() {
    if (!form.titleAr.trim()) { toast({ title: "يجب إدخال عنوان الاختبار", variant: "destructive" }); return; }
      ...
      >
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <Label>عنوان الاختبار <span className="text-destructive">*</span></Label>
            <Input value={form.titleAr} onChange={f("titleAr")} placeholder="اكتب عنوان الاختبار..." />
          </div>
