...
const SECTIONS = [
  {
    ...
    content:
      "باستخدامك لتطبيق أكاديمية جادي، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق على أي من هذه الشروط، يُرجى عدم استخدام التطبيق.",
  },
  {
    title: "وصف الخدمة",
    content:
      "أكاديمية جادي منصة تعليمية مستقلة توفر محتوى مراجعة للتلاميذ الجزائريين في المرحلة الثانوية. التطبيق ليس تابعاً لوزارة التربية الوطنية أو أي جهة حكومية.",
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "لا تتحمل أكاديمية جادي مسؤولية نتائج الامتحانات.",
